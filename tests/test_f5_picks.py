...
def test_analyze_f5_pick_recommends_home_ml_when_home_pitching_edge():
    ...
    # pitching_score > 0 means home pitching advantage; own_bullpen_score < -0.10 passes Gate 2
    result = _analyze_f5_pick(game, f5_odds, pitching_score=0.30, own_bullpen_score=-0.15)
